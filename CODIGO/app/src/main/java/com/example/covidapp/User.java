...
public class User {
    ...
    /**
     * Comunicación con el servidor para renovacion de token
     */
    class TokenTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            JSONObject answer;
            String result;
            if (!com.example.covidapp.Utils.isInternetAvailable()) {
                return false;
            }
            try {

                url = new URL(com.example.covidapp.Utils.URI_TOKEN_REFRESH);
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    result = com.example.covidapp.Utils.convertInputStreamToString(inputStreamReader).toString();
